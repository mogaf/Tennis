...
class CriticAgent():
    ...
    def __init__(self,state_size, action_size, random_seed,learning_rate,weight_decay,tau):
        self.id = id
        ...
        self.critic_optimizer = optim.Adam(self.critic_local.parameters(), lr=self.learning_rate, weight_decay=self.weight_decay)
